...
type (
	...
	PasswordAuthorizationHandler func(username, password string, code string, orgId string, authType string) (userID int64, orgID int64, authorities map[uint64]uint64, err error)
